...
OBJECTS += ./mbedModbus/Modbus/Modbus.o
OBJECTS += ./mbedModbus/ModbusTCP/ModbusTCP.o
...
INCLUDE_PATHS += -I.././mbedModbus
INCLUDE_PATHS += -I.././mbedModbus/Modbus
INCLUDE_PATHS += -I.././mbedModbus/ModbusTCP
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1535473779.0069602
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1535473779.0069602
...
ASM_FLAGS += -I.././mbedModbus
ASM_FLAGS += -I.././mbedModbus/Modbus
ASM_FLAGS += -I.././mbedModbus/ModbusTCP
